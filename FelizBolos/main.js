...
function orderForm(e) {
  ...
  uploadTask.on('state_changed', snapshot => {
    ...
    storage.ref('images').child(image.name).getDownloadURL().then(url => {
      ...
      var toppinngs = document.getElementById("toppings").options[document.getElementById("toppings").selectedIndex].text;
      var flavour = document.getElementById("flavour").options[document.getElementById("flavour").selectedIndex].text;
      var weight = document.getElementById("kg").options[document.getElementById("kg").selectedIndex].text;
      ...
      colRef.doc(orderNo).set(user_data).then(() => {
        alert("Order No: " + orderNo + " created successfully!\n\n Click on link " + window.location.origin + window.location.pathname + "orderSummary.html#" + orderNo);
        orderNo = Number(orderNo);
        window.open(window.location.origin + window.location.pathname + "orderSummary.html#" + orderNo, "_blank");
